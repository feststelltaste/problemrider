...
<br/>  Users who are confused by inconsistent system behavior become frustrated with the product.
- [User Trust Erosion](user-trust-erosion.md)
<br/>  When users cannot predict system behavior, they lose trust in the system's reliability.
- [Negative User Feedback](negative-user-feedback.md)
<br/>  Confused users provide negative feedback about the system's usability and design.
...
<br/>  When the system behaves differently for what should be identical operations, users become confused about expected behavior.
