...
<br/>  Users frustrated by the slow pace of new features and fixes become dissatisfied with the product.
...
<br/>  When components must be deployed together, individual features are held back until the entire bundle is ready.
- [Complex Deployment Process](complex-deployment-process.md)
<br/>  Complicated deployment procedures slow down the release cadence and delay getting value to users.
